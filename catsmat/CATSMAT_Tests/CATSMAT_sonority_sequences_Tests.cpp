//
//  CATSMAT_sonority_sequences_Tests.cpp
//  imusant
//
//  Created by Jason Stoessel on 11/05/2016.
//
//
...
#include "CATSMAT_sonority_sequences_Expected.h"

#include "gtest/gtest.h"
#include <boost/filesystem.hpp>

// The fixture for testing class CATSMAT_cp_matrix.
class CATSMAT_sonority_sequences_Test : public ::testing::Test {
    
protected:
    
    CATSMAT_sonority_sequences_Test() {
        // You can do set-up work for each test here.
    }
    
    virtual ~CATSMAT_sonority_sequences_Test() {
    ...
    CATSMAT::CATSMAT_sonority_sequences theSequences;
    
};

TEST_F(CATSMAT_sonority_sequences_Test, TestScore_1_Measure) {
    ...
    string the_sequences_as_string = testUtil.ConvertSonoritySequencesToString(theSequences);
    
    ASSERT_EQ(TestScore_1_Measure_Expected, the_sequences_as_string);
}

TEST_F(CATSMAT_sonority_sequences_Test, TestScore_4_Measures) {
...
TEST_F(CATSMAT_sonority_sequences_Test, TestScore_4_Measures_WithQuaverPassingNotes) {
...
TEST_F(CATSMAT_sonority_sequences_Test, TestScore_4_Measures_WithSemiQuaverPassingNotes) {
