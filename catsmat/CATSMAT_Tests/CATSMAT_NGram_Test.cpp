...
#include "CATSMAT_NGram_Test_Expected.h"

#include "gtest/gtest.h"
#include <boost/filesystem.hpp>

// The fixture for testing class CATSMAT_cp_matrix.
class CATSMAT_NGram_Test : public ::testing::Test {
...
TEST_F(CATSMAT_NGram_Test, TestScore_1_Measure) {
...
TEST_F(CATSMAT_NGram_Test, TestScore_4_Measures) {
...
TEST_F(CATSMAT_NGram_Test, TestScore_4_Measures_WithQuaverPassingNotes) {
...
TEST_F(CATSMAT_NGram_Test, TestScore_4_Measures_WithSemiQuaverPassingNotes) {
