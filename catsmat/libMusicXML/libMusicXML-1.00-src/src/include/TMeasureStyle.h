...
class EXP TMeasureRepeat : public TMeasureStyleElement {
    ...
    public:
		enum { undefined=-1 };
        EXP friend SMARTP<TMeasureRepeat> newMeasureRepeat(StartStop::type type);
		virtual void accept(TScoreVisitor& visitor);
...
class EXP TBeatRepeat : public TMeasureStyleElement {
    ...
    public:
		enum { undefined=-1 };
        EXP friend SMARTP<TBeatRepeat> newBeatRepeat(StartStop::type type);
		virtual void accept(TScoreVisitor& visitor);
...
class EXP TSlash : public TMeasureStyleElement {
    ...
    public:
        EXP friend SMARTP<TSlash> newSlash(StartStop::type type);
		virtual void accept(TScoreVisitor& visitor);
...
// the new functions
//______________________________________________________________________________
SMeasureStyle newMeasureStyle();
SMultipleRest newMultipleRest();
SMeasureRepeat newMeasureRepeat(StartStop::type t=StartStop::undefined);
SBeatRepeat newBeatRepeat(StartStop::type t=StartStop::undefined);
SSlash newSlash(StartStop::type t=StartStop::undefined);
