...
TEST_F(IMUSANT_duration_Tests, asAbsoluteNumeric)
{
    ...
    actual_val = duration->asAbsoluteNumeric();
    ASSERT_EQ(256, actual_val) << "A dotted crotchet that is part of a triplet.";  // There are rounding errors here.
...
TEST_F(IMUSANT_duration_Tests, asAbsoluteNumeric_SumOfTupleWithDots)
{
    ...
    dotted_crotchet_in_triplet_2->set(IMUSANT_duration::crochet, 1, *new TRational(3,2));
