//
//  CATSMAT_dyadtuple_sequences_Tests.cpp
//  imusant
//
//  Created by Derrick Hill on 11/07/2015.
//
//
...
#include "CATSMAT_dyadtuple_sequences_Expected.h"

#include "gtest/gtest.h"
#include <boost/filesystem.hpp>

// The fixture for testing class CATSMAT_cp_matrix.
class CATSMAT_dyadtuple_sequences_Test : public ::testing::Test {
    
protected:
    
    CATSMAT_dyadtuple_sequences_Test() {
        // You can do set-up work for each test here.
    }
    
    virtual ~CATSMAT_dyadtuple_sequences_Test() {
    ...
    CATSMAT::CATSMAT_dyadtuple_sequences theSequences;
