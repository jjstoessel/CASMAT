...
namespace IMUSANT
{
    ...
    IMUSANT_ending::type IMUSANT_ending::fTypeTbl[] =
    {
        undefined, start, stop
    };
    
    string	IMUSANT_ending::fTypeStrings[] =
    {
        "undefined", "start", "stop"
    };
    ...
    IMUSANT_repeat::direction IMUSANT_repeat::fDirectionTbl[] =
    {
        undefined, forward, backward
    };
    
    string	IMUSANT_repeat::fDirectionStrings[] =
    {
        "undefined", "forward", "backward"
    };
    ...
    xml (const string str)
    {
        return fDirection2String[str];
    }
    
    //==============================================================================
    //IMUSANT_barline
    
    IMUSANT_barline::location IMUSANT_barline::fLocationTbl[] =
    {
        right, left, middle
    };
    
    string IMUSANT_barline::fLocationStrings[]	=
    {
        "right", "left", "middle"
    };
    ...
    IMUSANT_barline::type IMUSANT_barline::fStyleTbl[] =
    {
        none, regular, dotted, heavy, light_light,
        light_heavy, heavy_light, heavy_heavy
    };
    
    string IMUSANT_barline::fStyleStrings[]	=
    {
        "none", "regular", "dotted", "heavy", "light-light",
