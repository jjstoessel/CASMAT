...
namespace IMUSANT
{
    ...
    public:
        ...
        void set(type name, unsigned short octave, unsigned short voice,
                 type ms_note, signed short accidental=0, bool is_chord=false);
        
        inline void set(type name, unsigned short octave, unsigned short voice,
                        signed short accidental=0, bool is_chord=false)
        {
        ...
        IMUSANT_pitch& operator= (const IMUSANT_pitch& pitch)
        {
            ...
            fMSName = pitch.ms_name();
            fInChord = pitch.in_chord();
            fVoice = pitch.voice();
            return *this;
        }
