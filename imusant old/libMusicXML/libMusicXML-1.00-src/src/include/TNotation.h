...
class EXP TGlissando : public TNotationElement, public Placementable, public Positionable {
    public:
		...
		EXP friend SMARTP<TGlissando> newGlissando(StartStop::type type);
        virtual void accept(TScoreVisitor& visitor);
...
class EXP TSlide : public TGlissando, public Bendable {
    public:
		EXP friend SMARTP<TSlide> newSlide (StartStop::type type);
        virtual void accept(TScoreVisitor& visitor);
...
class EXP TOtherNotation : public TNotationElement, public Placementable, public Positionable {
    public:
		...
		EXP friend SMARTP<TOtherNotation> newOtherNotation(StartStop::type type);
        virtual void accept(TScoreVisitor& visitor);
...
//______________________________________________________________________________
SNotation newNotation();
STie newTie(StartStop::type type = StartStop::undefined);
SSlur newSlur(StartStop::type type = StartStop::undefined);
SArticulations newArticulations();
SStrongAccent newStrongAccent();
SArticulationElement newArticulationElement(TArticulationElement::articulation type);
SOtherArticulation newOtherArticulation();
STupletDesc newTupletActual();
STupletDesc newTupletNormal();
STuplet newTuplet(StartStop::type type = StartStop::undefined);
SGlissando newGlissando(StartStop::type type = StartStop::undefined);
SSlide newSlide(StartStop::type type = StartStop::undefined);
SOtherNotation newOtherNotation(StartStop::type type = StartStop::undefined);
