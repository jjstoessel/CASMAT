...
class EXP TPedal : public TDirectionTypeElement, public Positionable {
    public:
		EXP friend SMARTP<TPedal> newPedal(StartStop::type t);        
		virtual void accept(TScoreVisitor& visitor);
...
//______________________________________________________________________________
    ...
    SRehearsal newRehearsal();
    SOtherDirection newOtherDirection();
    SPedal newPedal(StartStop::type t=StartStop::undefined);
    SPrint newPrint();
