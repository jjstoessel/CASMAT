...
class EXP TMordentOrnament : public TTrillOrnament {
    public:
        ...
        EXP friend SMARTP<TMordentOrnament> newMordentOrnament(TOrnament::type t);
        virtual void accept(TScoreVisitor& visitor);
...
// the new functions
//______________________________________________________________________________
SAccidentalMark newAccidentalMark();
SOrnaments newOrnaments();
SOrnament newOrnament(TOrnament::type t);
SOtherOrnament newOtherOrnament();
STrillOrnament newTrillOrnament(TOrnament::type t);
SMordentOrnament newMordentOrnament(TOrnament::type t);
SWavyLine newWavyLine(StartStop::type t = StartStop::undefined);
