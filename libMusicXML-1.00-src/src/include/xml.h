...
/*!
\brief a class for generating the MusicXML header.
*/
class EXP xmlheader : public smartable {
     ...
     public:
        ...
        EXP friend SMARTP<xmlheader> new_xmlheader(int mode, string loc);
...
Sxmlheader new_xmlheader(int mode=xmlheader::partwise, string loc="http://www.musicxml.org/dtds/");
