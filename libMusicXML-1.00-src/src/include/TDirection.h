...
// the new functions
//______________________________________________________________________________
    SOctaveShift newOctaveShift(int type = TOctaveShift::undefined);
    SBracket newBracket(StartStop::type t = StartStop::undefined);
    SDashes newDashes(StartStop::type t = StartStop::undefined);
    SWords newWords();
    SWedge newWedge(int type = TOctaveShift::undefined);
    SSymbolicNoteDuration newSymbolicNoteDuration();
    SMetronome newMetronome();
    SDirectionType newDirectionType();
