...
class VEXP guidoparam : public smartable, public guidovisitable {
	public:
        VEXP friend SMARTP<guidoparam> new_guidoparam(string value, bool quote);
        VEXP friend SMARTP<guidoparam> new_guidoparam(long value, bool quote);
...
Sguidoparam new_guidoparam(string value, bool quote=true);
Sguidoparam new_guidoparam(long value, bool quote=true);
...
Sguidoseq new_guidoseq();
Sguidochord new_guidochord();
Sguidotag new_guidotag(string name);
